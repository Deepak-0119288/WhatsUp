  ...
  return (
    ...
    <div className="px-5 flex flex-col md:flex-row justify-between items-center">
      ...
      <div className="flex gap-6 cursor-pointer relative">
        <div
          className="relative group add-chat-container"
        ...
        >
          ...
          />
          <span className="absolute left-1/2 -translate-x-1/2 top-8 whitespace-nowrap bg-black text-white px-3 py-1 text-sm rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-200">
            New Group
          </span>

          {AddMenuOpen && (
            <div className="absolute -left-14 top-8 bg-white shadow-md rounded-lg w-53">
              <ul className="py-2">
                <li className="px-4 py-2 text-gray-600 hover:bg-gray-200 cursor-pointer flex items-center space-x-2">
                ...
                <li className="px-4 py-2 text-gray-600 hover:bg-gray-200 cursor-pointer flex items-center space-x-2">
                  <div className="w-14 h-11 bg-emerald-600 rounded-full flex items-center justify-center">
                    <svg
                      viewBox="0 0 28 19"
        ...
        >
          ...
          {menuOpen && (
            <div className="absolute -left-28 top-8 bg-white shadow-md rounded-lg w-40">
              <ul className="py-2">
                <li
