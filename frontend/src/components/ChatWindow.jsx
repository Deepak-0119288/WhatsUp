...
export default function ChatWindow() {
  ...
  if (!selectedChat) {
    return (
      <div className="h-[100vh] w-[952px] bg-cover bg-center bg-[#e7ddd2] mt-6">
  ...
  return (
    <div className="h-[100vh] w-[952px] bg-center bg-cover overflow-hidden mt-6">
      <div className="flex-1 flex-col overflow-auto">
        <ChatHeader />
        <div ref={chatContainerRef} className="h-[75vh] bg-[url('../public/d-img.jpg')] overflow-y-auto p-4">
          {messages.length === 0 ? (
        ...
        <div className="p-4 bg-[#e9edef] h-[7vh]">
          <form onSubmit={handleSendMessage} className="relative flex items-center gap-2">
            ...
            <input
              type="text"
              className="w-full text-black outline-none bg-white input input-bordered rounded-lg input-lg sm:input-md transition-all"
